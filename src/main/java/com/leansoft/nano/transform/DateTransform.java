...
class DateTransform implements Transformable<Date> {
    ...
    public static String yyyyMMdd_T_HHmmssZZZZZ = "yyyy-MM-dd'T'HH:mm:ssZZZZZ";

    public static String yyyyMMdd_T_HHmmssSSSZZZZZ = "yyyy-MM-dd'T'HH:mm:ss.SSSZZZZZ";
    ...
    public static String getPattern(String text) {
        ...
        if (length > 28) {
            return yyyyMMdd_T_HHmmssSSSZZZZZ;
        }
        if (length > 23) {
            return yyyyMMdd_T_HHmmssZZZZZ;
        }
        if (length > 23) {
            return FULL;
        }
